package net.motaso.wobble.sound;
...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, Wobble.MODID);
    ...
    public static final RegistryObject<SoundEvent> NEBO_I_SIMA = registerSoundEvents("nebo_i_sima");
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Wobble.MODID, name)));
    }
